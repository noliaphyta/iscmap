...
// so we negate y everywhere. The map is also horizontally mirrored (x
// negated) relative to the source data, so we negate x too. These two
// helpers are the only place that conversion happens - everything else
// just works in "pixel space".
